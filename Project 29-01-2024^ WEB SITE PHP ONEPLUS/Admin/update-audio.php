...
<body>
    ...
    <select name="audios_id">

    <?php

 foreach ($audio as $aud) {
     echo "<option value='$aud[id]'>$aud[title]</option>";
 }
?>
    </select>
...
<!-- Creem un input de tip file -->
        <input type="file" name="imag[]" id="imag" multiple accept="image/*">
...
foreach($audio as $aud) {
    echo "
    <option value = '$aud[id]'>$aud[title]</option>
    ";
}
?>
        </select>
